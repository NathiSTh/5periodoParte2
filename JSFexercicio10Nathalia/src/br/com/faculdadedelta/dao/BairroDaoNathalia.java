...
public class BairroDaoNathalia {
	
	public void incluir(BairroNathalia bairro) throws Exception {
	...
	public void alterar(BairroNathalia bairro) throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
	...
	public void excluir(BairroNathalia bairro) throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
	...
	public List<BairroNathalia>  listar() throws Exception{
		Connection conn = Conexao.conectarNoBancoDeDados();
		String sql = "SELECT\r\n" + 
		...
		try {
			while(rs.next()) {
				BairroNathalia bairro = new BairroNathalia();
	...
	public BairroNathalia pesquisarPorId(Long id) throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
	String sql = "SELECT * FROM bairros WHERE id_bairro=? ";
	PreparedStatement ps = null;
	ResultSet rs = null;
	BairroNathalia retorno = new BairroNathalia();
