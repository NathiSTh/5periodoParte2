...
public class InfracaoDaoNathalia {

	public void incluir(InfracaoNathalia infracao) throws Exception {
	...
	public void alterar(InfracaoNathalia infracao) throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
	...
	public void excluir(InfracaoNathalia infracao) throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
	...
	public List<InfracaoNathalia> listar() throws Exception {
		Connection conn = Conexao.conectarNoBancoDeDados();
		String sql = "SELECT * FROM infracoes";
		PreparedStatement ps = conn.prepareStatement(sql);
		ResultSet rs = ps.executeQuery();
		List<InfracaoNathalia> listaRetorno = new ArrayList<>();
		try {
			while (rs.next()) {
